...
buildProperties({
    node: {
        packageJson: {
            name: "{{name}}",
            version: "{{version}}",
            description: "bugcli is a JS library for building command line applications",
            main: "./scripts/bugcli-node.js",
            dependencies: dependencies,
            author: "Brian Neisler <brian@airbug.com>",
            repository: {
                type: "git",
                url: "https://github.com/airbug/{{name}}.git"
            },
            bugs: {
                url: "https://github.com/airbug/{{name}}/issues"
            },
            licenses: [
                {
                    type : "MIT",
                    url : "https://raw.githubusercontent.com/airbug/{{name}}/master/LICENSE"
                }
            ]
        },
        sourcePaths: [
